...
{
    public static final EYBCardData DATA = Register(ToushirouHitsugaya.class).SetAttack(1, CardRarity.RARE, EYBAttackType.Normal)
    ...
    public void OnUse(AbstractPlayer p, AbstractMonster m, CardUseInfo info)
    {
        ...
        GameActions.Bottom.ApplyFreezing(TargetHelper.Normal(m), magicNumber).ShowEffect(true, true).AddCallback(m, (enemy, __) -> {
            ...
            {
                GameActions.Bottom.ReducePower(enemy, BurningPower.POWER_ID, secondaryValue);
