...
public class JetBlack extends AnimatorBetaCard
{
    public static final EYBCardData DATA = Register(JetBlack.class).SetAttack(2, CardRarity.UNCOMMON, EYBAttackType.Normal, EYBCardTarget.ALL).SetColor(CardColor.COLORLESS).SetSeries(BetaCardSeries.CowboyBebop);
