...
public class ArseneLupin extends AnimatorBetaCard
{
    public static final EYBCardData DATA = Register(ArseneLupin.class).SetAttack(1, CardRarity.UNCOMMON, EYBAttackType.Ranged, EYBCardTarget.Random).SetColor(CardColor.COLORLESS).SetSeries(BetaCardSeries.Lupin).SetMaxCopies(2);
