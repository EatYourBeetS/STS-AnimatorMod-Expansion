...
public class Senku extends AnimatorBetaCard
{
    public static final EYBCardData DATA = Register(Senku.class).SetAttack(1, CardRarity.UNCOMMON).SetColor(CardColor.COLORLESS).SetMaxCopies(2).SetSeries(BetaCardSeries.DrStone);
    ...
    {
        AbstractGameAction.AttackEffect attackEffect = this.transformed || this.attackType.equals(EYBAttackType.Elemental) ? AttackEffects.LIGHTNING : AttackEffects.BLUNT_LIGHT;
        ...
        for (Map.Entry<String,Integer> debuff : debuffs.entrySet()) {
            ...
            if (helper != null) {
                ...
                BetaActions.Bottom.ApplyPower(this.attackTarget.equals(EYBCardTarget.ALL) ? TargetHelper.Enemies() : TargetHelper.Normal(m), helper, debuff.getValue());
            }
        }
    }
