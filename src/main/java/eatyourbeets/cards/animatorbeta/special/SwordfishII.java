...
public class SwordfishII extends AnimatorBetaCard
{
    public static final EYBCardData DATA = Register(SwordfishII.class).SetSkill(0, CardRarity.SPECIAL, EYBCardTarget.None).SetColor(CardColor.COLORLESS).SetSeries(BetaCardSeries.CowboyBebop);
    ...
    public static class SwordfishIIPower extends AnimatorPower
    {
        ...
        public void atEndOfTurn(boolean isPlayer)
        {
            if (strikeCount > 0)
            {
                ...
                GameActions.Bottom.DealDamageToAll(damage, DamageInfo.DamageType.THORNS, AttackEffects.GUNSHOT);
