...
public class Fischl_Oz extends AnimatorBetaCard
{
    public static final EYBCardData DATA = Register(Fischl_Oz.class).SetPower(2, CardRarity.SPECIAL).SetSeries(CardSeries.GenshinImpact);
