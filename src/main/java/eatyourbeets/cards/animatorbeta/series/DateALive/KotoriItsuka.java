...
public class KotoriItsuka extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(KotoriItsuka.class).SetAttack(1, CardRarity.UNCOMMON, EYBAttackType.Normal);
