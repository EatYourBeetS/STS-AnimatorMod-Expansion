...
public class UryuuIshida extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(UryuuIshida.class).SetAttack(1, CardRarity.COMMON, EYBAttackType.Ranged);
