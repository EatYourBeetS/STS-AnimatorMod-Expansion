...
public class ZarakiKenpachi extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(ZarakiKenpachi.class).SetPower(2, CardRarity.RARE);
