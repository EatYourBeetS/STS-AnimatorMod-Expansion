...
public class GinIchimaru extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(GinIchimaru.class).SetAttack(1, CardRarity.UNCOMMON, EYBAttackType.Piercing, EYBCardTarget.Random);
