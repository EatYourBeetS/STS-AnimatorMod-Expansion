...
public class Venti extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(Venti.class).SetSkill(2, CardRarity.RARE, EYBCardTarget.None).SetMaxCopies(2);
