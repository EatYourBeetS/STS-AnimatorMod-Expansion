...
public class SougenEsaka extends AnimatorBetaCard
{
    public static final EYBCardData DATA = RegisterSeriesCard(SougenEsaka.class).SetAttack(1, CardRarity.COMMON, EYBAttackType.Normal, EYBCardTarget.ALL);
