...
// TODO a generic dropdown component with a menu. Note that the pop up compability in advancedhitbox, and the SetSmartText function in GUI_Label is required to make this work
// TODO The GR.PCL.Strings calls have been deliberately left alone to signify parts of the code that require you to supply your own strings
public class GUI_Dropdown<T> extends GUIElement
{
    ...
    public ArrayList<T> GetAllItems() {
        return BetaJUtils.Map(this.rows, row -> row.item);
    }
